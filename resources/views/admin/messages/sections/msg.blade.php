                ...
                <table class="table table-hover table-borderless display" id="_table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><a href="{{route('msg_details')}}" class="text-decoration-none text-dark">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Omnis possimus distinctio amet in explicabo ea perspiciatis, sit, modi quasi illo...</a></td>
                            <td>Jhon Doe</td>
