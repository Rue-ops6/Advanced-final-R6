            <div class="row justify-content-between mb-2 pb-2">
                ...
                <a href="{{route('add_topic')}}" class="btn btn-link  link-dark fw-semibold col-auto me-3">➕Add More Topics</a>
            </div>
            ...
            <div class="p-5">
                <div class="container-fluid g-0 pt-3 pb-5 px-lg-5 px-md-3 px-1">
                    ...
                    >
                      <img
                        src="{{asset('assets/admin/images/topics/colleagues-working-cozy-office-medium-shot.png')}}"
