          ...
          <div class="container justify-content-md-center">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <a class="nav-link dropdown-toggle {{request()->routeIs('users') ? 'active' : ''}}" role="button" data-bs-toggle="dropdown"
                aria-expanded="false">
                    USERS
                  </a>
                ...
                <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle {{request()->routeIs('topics') ? 'active' : ''}}" role="button" data-bs-toggle="dropdown"
                aria-expanded="false">
                    TOPICS
                  </a>
                  <ul class="dropdown-menu">
                ...
                <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle {{request()->routeIs('categories') ? 'active' : ''}}" role="button" data-bs-toggle="dropdown"
                aria-expanded="false">
                    CATEGORIES
                  </a>
                  <ul class="dropdown-menu">
                ...
                <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle {{request()->routeIs('testimonials') ? 'active' : ''}}" role="button" data-bs-toggle="dropdown"
                aria-expanded="false">
                    TESTIMONIALS
                  </a>
                  <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item" href="{{route('add_testimonial')}}">Add testimonial</a></li>
                  </ul>
                </li>
